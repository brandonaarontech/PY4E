...
# Chapter: 08
# Exercise: 05
# Description: Open the file mbox-short.txt and read it line by line. When you 
...
# print out a count at the end. Hint: make sure not to include the lines that 
# start with 'From:'. Also look at the last line of the sample output to see how 
# to print the count.
